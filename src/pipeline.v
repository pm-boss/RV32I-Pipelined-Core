...
(
    ...
    wire              dmem_write_ready_i;
    wire              dmem_read_ready_i;
    wire [31:0]       dmem_write_address_i;
    wire [31:0]       dmem_read_address_i;
    wire [1:0]        dmem_read_offset;
    wire [31:0]       dmem_write_data_i;
    wire [3:0]        dmem_write_byte_i;
...
assign inst_mem_address     = inst_mem_address_i;
...
IF_ID IF_ID_stage (
    ...
    .inst_mem_offset    (inst_mem_address_i[1:0]),
...
wb wb_stage (
    ...
    .mem_write_i        (mem_write && !branch_stall), // 1. Use raw EX write signal
    .write_address_i    (write_address),              // 2. Use calculated EX address
    .alu_operand2_i     (reg_rdata2),                 // 3. Use actual rs2 register data
    ...
    .inst_mem_address_o (inst_mem_address_i),
