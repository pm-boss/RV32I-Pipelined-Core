...
assign inst_mem_address_o  = fetch_pc_i;  //fetch_pc_i and stall_read_i are comin frm input file (output of execute stage)
...
always @(*) begin
    if (!reset) begin
        ...
        case (alu_operation_i) //alu operation for writing data(wb_wdata) to memory
		...
		// TODO-WB: Store Byte (SB)
            SB: begin
                ...
                case (write_address_i[1:0])
                    ...
                    2'b01:  wb_write_byte_o <= 4'b0010;                             //TODO DONE
		...
		// TODO-WB: Store Halfword (SH)
            SH: begin
                ...
                wb_write_byte_o <= write_address_i[1] ? 4'b1100 : 4'b0011;              //TODO DONE
            end
            SW: begin
...
always @* begin
    case (wb_alu_operation_i) //alu operation for loading data(w_rdata) frm mem
        LB: begin // Load byte
            case (wb_read_address_i)
                ...
                2'b11: wb_read_data_o = {{24{dmem_read_data_i[31]}}, dmem_read_data_i[31:24]};              //TODO DONE
            endcase
        end
